...
func BenchmarkDay22Part1(b *testing.B) {
	for i := 0; i < b.N; i++ {
		day22part1 = Part1(ax.MustReadFineLines("input"))
	}
}

func TestDay22Part1(t *testing.T) {
	assert.Equal(t, 590784, Part1(ax.MustReadFineLines("small")))
	assert.Equal(t, 527915, Part1(ax.MustReadFineLines("input")))
}
